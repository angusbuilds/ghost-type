...
<p align="center">
  <img alt="tests" src="https://img.shields.io/badge/tests-293%20passing-brightgreen">
...
cd ghost-type
node --test          # 293 tests, all offline — spends no tokens
```
...
293 tests, all offline (`node --test`) · independently audited by Codex (gpt-5.6-sol, xhigh) across twenty-eight rounds — every finding fixed
```
