...
<p align="center">
  <img alt="tests" src="https://img.shields.io/badge/tests-358%20passing-brightgreen">
...
cd ghost-type
node --test          # 358 tests, all offline — spends no tokens
```
...
358 tests, all offline (`node --test`) · independently audited by Codex (gpt-5.6-sol, xhigh) and by a parallel multi-agent sweep — every finding fixed
```
