...
<p align="center">
  <img alt="tests" src="https://img.shields.io/badge/tests-270%20passing-brightgreen">
...
cd ghost-type
node --test          # 270 tests, all offline — spends no tokens
```
...
270 tests, all offline (`node --test`) · independently audited by Codex (gpt-5.6-sol, xhigh) across twenty-two rounds — every finding fixed
```
