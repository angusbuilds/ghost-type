...
<p align="center">
  <img alt="tests" src="https://img.shields.io/badge/tests-272%20passing-brightgreen">
...
cd ghost-type
node --test          # 272 tests, all offline — spends no tokens
```
...
272 tests, all offline (`node --test`) · independently audited by Codex (gpt-5.6-sol, xhigh) across twenty-four rounds — every finding fixed
```
