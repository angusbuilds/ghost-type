...
<p align="center">
  <img alt="tests" src="https://img.shields.io/badge/tests-296%20passing-brightgreen">
...
cd ghost-type
node --test          # 296 tests, all offline — spends no tokens
```
...
296 tests, all offline (`node --test`) · independently audited by Codex (gpt-5.6-sol, xhigh) across twenty-eight rounds — every finding fixed
```
