...
<p align="center">
  <img alt="tests" src="https://img.shields.io/badge/tests-241%20passing-brightgreen">
...
cd ghost-type
node --test          # 241 tests, all offline — spends no tokens
```
...
241 tests, all offline (`node --test`) · independently audited by Codex (gpt-5.6-sol, xhigh) across seventeen rounds — every finding fixed
```
