...
<p align="center">
  <img alt="tests" src="https://img.shields.io/badge/tests-259%20passing-brightgreen">
...
cd ghost-type
node --test          # 259 tests, all offline — spends no tokens
```
...
259 tests, all offline (`node --test`) · independently audited by Codex (gpt-5.6-sol, xhigh) across eighteen rounds — every finding fixed
```
