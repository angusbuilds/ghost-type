...
<p align="center">
  <img alt="tests" src="https://img.shields.io/badge/tests-239%20passing-brightgreen">
...
cd ghost-type
node --test          # 239 tests, all offline — spends no tokens
```
...
239 tests, all offline (`node --test`) · independently audited by Codex (gpt-5.6-sol, xhigh) across five rounds — every finding fixed
```
